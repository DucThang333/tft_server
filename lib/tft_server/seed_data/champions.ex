defmodule TftServer.SeedData.Champions do
  ...
  defp simple(id, name, cost, role_type_id, traits, skill_name, template, params, base_hp) do
    %{
      "id" => id,
      "name" => name,
      "cost" => cost,
